...
from skvisualizations.scores import scores_table, hypotheses_table
    ...
    for multitest in ("kruskal", "friedmanchisquare", None):
        for test in ("mannwhitneyu", "wilcoxon"):
            ...
            for correction in (
                ...
                hypotheses_table(scores, estimators, multitest=multitest, test=test, correction=correction)
